...
bool
priority_compare(const struct list_elem* left, const struct list_elem* right, void* aux){
...
update_priority(void) {
  ...
  // intr 도중이므로 thread_yield 대신 intr_yield_on_return을 호출한다.
